...
public struct SystemHashSearcher() : IHashSearcher<SystemHashSearcher>
{
    #region Create

    public static SystemHashSearcher Create() => new();

    #endregion

    #region Static

    static SystemHashSearcher()
    {
...
#pragma warning restore CS0649
    ...
    private readonly ref Slot SlotAt(nuint index) => ref Unsafe.As<SlotNoAlign, Slot>(ref m_slots.GetUnchecked(index));
